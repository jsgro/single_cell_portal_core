class BannerImageUploader < CarrierWave::Uploader::Base
  ...
  process :save_content_type_and_size_for_banner_image

  def save_content_type_and_size_for_banner_image
    model.banner_image_content_type = file.content_type if file.content_type
    model.banner_image_file_size = file.size
  end
