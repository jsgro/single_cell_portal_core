  ...
  module V1
    class ExpressionDataController < ApiBaseController
      ...
      def render_violin
        ...
        selected_annotation = ExpressionVizService.get_selected_annotation(params, @study, cluster)
      ...
      def render_annotation_values
        cluster = ClusterRenderingService.get_cluster_group(params, @study)
        annotation = ExpressionVizService.get_selected_annotation(params, @study, cluster)
