    ...
    class StudyFilesController < ApiBaseController
      ...
      def study_file_params
        params.require(:study_file).permit(:_id, :taxon_id, :genome_assembly_id, :study_file_bundle_id, :name,
                                           ...
                                           :x_axis_max, :y_axis_min, :y_axis_max, :z_axis_min, :z_axis_max, :heatmap_scaling_mode, :species, :assembly,
                                           ...
                                           heatmap_file_info_attributes: [:id, :_destroy, :custom_scaling, :color_min, :color_max])
      end
    end
  end
end
