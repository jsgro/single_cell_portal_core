...
6. If you start up your local, undockerized SCP and the portal instance erroneously instructs you to accept Terra terms of service, IF you've also recently used dockerized local SCP, you will need to clean up your settings by running `bin/docker-compose-cleanup.sh`; follow the prompt to re-load your environment, then restart your local rails and vite servers.
