...
JSON_EXTRACT_SCALAR(sequence_file.descriptor, '$.file_name') AS sequence_file_name,
JSON_EXTRACT_SCALAR(sequence_file.descriptor, '$.size') AS sequence_file_size,
analysis_file.file_id AS drs_id,
JSON_EXTRACT_SCALAR(analysis_file.descriptor, '$.file_name') AS analysis_file_name,
JSON_EXTRACT_SCALAR(analysis_file.descriptor, '$.size') AS analysis_file_size,
